  ...
  <el-container class="home-container">
    ...
    <el-container>
      <el-aside width="200px">
        ...
        >
          <el-menu-item index="/homeworking">
            <template slot="title">
              <i class="el-icon-edit"></i>
              <span>待完成作业</span>
            </template>
          </el-menu-item>
          <el-menu-item index="/homeworked">
            <template slot="title">
  ...
  methods: {
    ...
    updatePassword() {
      this.$refs.ruleForm.validate(async valid => {
        ...
        const { data: info } = await this.$http.get('/student/getname', {
          params: { id: this.id }
        })
        ...
        const { data: res } = await this.$http.put('/student/password', {
